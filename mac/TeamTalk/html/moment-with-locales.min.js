...
(function(a) {
    ...
    function(a) {
        ...
        return a.defineLocale("hi", {
            ...
            meridiemHour: function(a, b) {
                return 12 === a && (a = 0),
                "रात" === b ? 4 > a ? a: a + 12 : "सुबह" === b ? a: "दोपहर" === b ? a >= 10 ? a: a + 12 : "शाम" === b ? a + 12 : void 0
            },
            meridiem: function(a) {
    ...
    function(a) {
        ...
        return a.defineLocale("mr", {
            ...
            meridiemHour: function(a, b) {
                return 12 === a && (a = 0),
                "रात्री" === b ? 4 > a ? a: a + 12 : "सकाळी" === b ? a: "दुपारी" === b ? a >= 10 ? a: a + 12 : "सायंकाळी" === b ? a + 12 : void 0
            },
            meridiem: function(a) {
    ...
    function(a) {
        ...
        return a.defineLocale("ne", {
            ...
            meridiemHour: function(a, b) {
                return 12 === a && (a = 0),
                "राती" === b ? 3 > a ? a: a + 12 : "बिहान" === b ? a: "दिउँसो" === b ? a >= 10 ? a: a + 12 : "बेलुका" === b || "साँझ" === b ? a + 12 : void 0
            },
            meridiem: function(a) {
    ...
    function(a) {
        ...
        return a.defineLocale("ta", {
            ...
            meridiemHour: function(a, b) {
                return 12 === a && (a = 0),
                "யாமம்" === b ? 2 > a ? a: a + 12 : "வைகறை" === b || "காலை" === b ? a: "நண்பகல்" === b && a >= 10 ? a: a + 12
            },
            week: {
                dow: 0,
                doy: 6
    ...
    function(a) {
        ...
        return a.defineLocale("zh-cn", {
            ...
            calendar: {
                sameDay: function() {
                    return 0 === this.minutes() ? "[今天]Ah[:00]": "[今天]LT"
                },
                nextDay: function() {
                    return 0 === this.minutes() ? "[明天]Ah[:00]": "[明天]LT"
                },
                lastDay: function() {
                    return 0 === this.minutes() ? "[昨天]Ah[:00]": "[昨天]LT"
                },
                nextWeek: function() {
                    var b, c;
                    return b = a().startOf("week"),
                    c = this.unix() - b.unix() >= 604800 ? "[下]": "[本]",
                    0 === this.minutes() ? c + "dddAh[:00]": c + "dddAh:mm"
                },
                lastWeek: function() {
                    var b, c;
                    return b = a().startOf("week"),
    ...
    function(a) {
        ...
        return a.defineLocale("zh-tw", {
            ...
            meridiemHour: function(a, b) {
                return 12 === a && (a = 0),
                "早上" === b || "上午" === b ? a: "中午" === b ? a >= 11 ? a: a + 12 : "下午" === b || "晚上" === b ? a + 12 : void 0
            },
            meridiem: function(a, b) {
                var c = 100 * a + b;
