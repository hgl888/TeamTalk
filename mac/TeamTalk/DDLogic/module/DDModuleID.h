...
//static const uint16 MODULE_ID_REMOTEBASE = 0x0000U; //与服务器端交互的module id
//static const uint16 MODULE_ID_LOCALBASE = 0x4000U;  //本地业务的module id
...
//    MODULE_ID_FILETRANSFER      = MODULE_ID_REMOTEBASE | 0x005A,    //文件传输模块
