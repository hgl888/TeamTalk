...
#define kStrMoveApplicationQuestionTitleHome _I10NS(@"我想住进你的应用程序文件夹，可以么？么么哒")
#define kStrMoveApplicationQuestionMessage _I10NS(@"只要你允许，我会自己钻进去哦！！")
#define kStrMoveApplicationButtonMove _I10NS(@"移动到程序文件夹")
#define kStrMoveApplicationButtonDoNotMove _I10NS(@"残忍的拒绝")
