package com.show.tt.protobuf.helper;

import com.google.protobuf.ByteString;
import com.show.tt.DB.entity.DepartmentEntity;
...
public class ProtoBuf2JavaBean {
    ...
    public static SessionEntity getSessionEntity(IMBaseDefine.ContactSessionInfo sessionInfo){
        ...
        String desMessage = new String(com.show.tt.Security.getInstance().DecryptMsg(content));
        // 判断具体的类型是什么
