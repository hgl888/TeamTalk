...
import com.show.tt.imservice.callback.ListenerQueue;
import com.show.tt.imservice.callback.Packetlistener;
import com.show.tt.imservice.event.SocketEvent;
import com.show.tt.imservice.network.MsgServerHandler;
import com.show.tt.imservice.network.SocketThread;
import com.show.tt.protobuf.IMBaseDefine;
import com.show.tt.protobuf.base.DataBuffer;
import com.show.tt.protobuf.base.DefaultHeader;
...
public class IMSocketManager extends IMManager {
    ...
    public void sendRequest(GeneratedMessageLite requset,int sid,int cid,Packetlistener packetlistener){
        ...
        try{
            //组装包头 header
            com.show.tt.protobuf.base.Header header = new DefaultHeader(sid, cid);
    ...
    public void packetDispatch(ChannelBuffer channelBuffer){
        ...
        com.show.tt.protobuf.base.Header header = new com.show.tt.protobuf.base.Header();
