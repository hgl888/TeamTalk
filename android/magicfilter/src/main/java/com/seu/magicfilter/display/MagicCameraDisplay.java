...
public class MagicCameraDisplay extends MagicDisplay{	
	...
	public void startFaceDetect(FaceDetectionListener listener )
	{
		Camera.Parameters params = CameraEngine.getCamera().getParameters();
		if( params.getMaxNumDetectedFaces() > 0 ){
			CameraEngine.getCamera().setFaceDetectionListener(listener);
			CameraEngine.getCamera().startFaceDetection();
		}
	}
	...
	public void stopFaceDetect()
	{
		Camera.Parameters params = CameraEngine.getCamera().getParameters();
		if( params.getMaxNumDetectedFaces() > 0 ){
			CameraEngine.getCamera().setFaceDetectionListener(null);
			CameraEngine.getCamera().stopFaceDetection();
		}
	}
