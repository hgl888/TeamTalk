...
MARIADB_DEVEL=MariaDB-10.0.24-centos6-x86_64-devel
MARIADB_DEVEL_DOWNLOAD_PATH=http://ftp.kaist.ac.kr/mariadb/yum/10.0/rhel6-amd64/rpms/$MARIADB_DEVEL.rpm

MARIADB_COMMON=MariaDB-10.0.24-centos6-x86_64-common
MARIADB_COMMON_DOWNLOAD_PATH=http://ftp.kaist.ac.kr/mariadb/yum/10.0/rhel6-amd64/rpms/$MARIADB_COMMON.rpm

MARIADB_COMPAT=MariaDB-10.0.24-centos6-x86_64-compat
MARIADB_COMPAT_DOWNLOAD_PATH=http://ftp.kaist.ac.kr/mariadb/yum/10.0/rhel6-amd64/rpms/$MARIADB_COMPAT.rpm
CUR_DIR=
